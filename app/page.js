...
export default function HomePage() {
  return (
    <>
      <span className="tag">창간호 · 권두언</span>
      <h1>전 망한 게 아니에요,<br />졸업한 거예요. <em>—— 졸업</em></h1>
      <p className="lead">
      ...
      <div className="card-grid">
        <a href="/diagnose" className="card">
          ...
          <h3>폐업 진단</h3>
          <p>업종·연차·직원수를 입력하면 30개 절차 중 본인에게 해당하는 항목만 골라 4주 캘린더를 만들어드립니다.</p>
        </a>
        <a href="/match" className="card">
          <span className="tag">1:1 인연</span>
          <h3>코치 매칭</h3>
          <p>5년 이상 자영업 후 폐업을 직접 경험한 선배 사장님과 매칭됩니다. 1호 코치는 평택 족발 10년 박용군.</p>
        </a>
        <a href="/resume" className="card">
          <span className="tag">도전 경력서</span>
          <h3>실패 경력서</h3>
      ...
      <a href="/story" className="coach-banner">
        <div className="avatar" style={{ width: 72, height: 72, fontSize: 32 }}>박</div>
        <div style={{ flex: 1 }}>
          <div style={{ fontFamily: 'var(--f-display)', fontWeight: 700, marginBottom: 4 }}>
            1호 코치 박용군 — 평택 족발 10년 (2011 〜 2021, 코로나 폐업)
          </div>
      ...
      <h2>4주 30개 절차 동행</h2>
      <p>
        ① <strong>신용회복</strong> 8개 · ② <strong>법무</strong> 8개 · ③ <strong>세무</strong> 8개 · ④ <strong>심리·재출발</strong> 6개.
        모두 1호 코치(박용군)가 5년 전 평택 족발집을 닫으며 직접 헤맸던 항목들입니다.
      </p>
